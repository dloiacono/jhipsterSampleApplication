...
@Configuration
@EnableJpaRepositories("io.github.dloiacono.jhipster.sample.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.github.dloiacono.jhipster.sample.repository.search")
